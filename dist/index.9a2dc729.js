var yourDate = "2021-11-17" // Your date here
;
!function(e) {
    var t = {
    };
    ...
    a.m = e, a.c = t, a.d = function(e, t, s) {
        ...
        if (a.r(s), Object.defineProperty(s, "default", {
            enumerable: !0,
            value: e
        }), 2 & t && "string" != typeof e) for(var n in e)a.d(s, n, (function(t) {
            return e[t];
        }).bind(null, n));
        return s;
    }, a.n = function(e) {
    ...
    function(e, t, a) {
        (function(e) {
            e.exports = (function() {
                ...
                function L(e) {
                    if (null == e._isValid) {
                        var t = M(e), a = s.call(t.parsedDateParts, function(e) {
                            return null != e;
                ...
                s = Array.prototype.some ? Array.prototype.some : function(e) {
                    var t, a = Object(this), s = a.length >>> 0;
                ...
                function H(e, t) {
                    ...
                    for(a in t)d(t, a) && (i(e[a]) && i(t[a]) ? (s[a] = {
                    }, c(s[a], e[a]), c(s[a], t[a])) : null != t[a] ? s[a] = t[a] : delete s[a]);
                    for(a in e)d(e, a) && !d(t, a) && i(e[a]) && (s[a] = c({
                    }, s[a]));
                    return s;
                }
                function j(e) {
                ...
                var O = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|N{1,5}|YYYYYY|YYYYY|YYYY|YY|y{2,4}|yo?|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, P = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, W = {
                }, E = {
                };
                function A(e, t, a, s) {
                    var n = s;
                ...
                var $, Q = /\d/, X = /\d\d/, ee = /\d{3}/, te = /\d{4}/, ae = /[+-]?\d{6}/, se = /\d\d?/, ne = /\d\d\d\d?/, re = /\d\d\d\d\d\d?/, ie = /\d{1,3}/, de = /\d{1,4}/, _e = /[+-]?\d{1,6}/, oe = /\d+/, ue = /[+-]?\d+/, me = /Z|[+-]\d\d:?\d\d/gi, le = /Z|[+-]\d\d(?::?\d\d)?/gi, ce = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
                function he(e, t, a) {
                ...
                var ke, De = 0, ge = 1, Te = 2, we = 3, ve = 4, be = 5, Se = 6, He = 7, je = 8;
                function xe(e, t) {
                ...
                var Oe = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), Pe = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, Ee = ce, Ae = ce;
                function Fe(e, t) {
                    var a;
                ...
                function Ne() {
                    ...
                    for(t = 0; t < 12; t++)a = h([
                        2000,
                        t
                    ]), s.push(this.monthsShort(a, "")), n.push(this.months(a, "")), r.push(this.months(a, "")), r.push(this.monthsShort(a, ""));
                ...
                A("Y", 0, 0, function() {
                    ...
                    6,
                    !0
                ], 0, "year"), J("year", "y"), U("year", 1), he("Y", ue), he("YY", se, X), he("YYYY", de, te), he("YYYYY", _e, ae), he("YYYYYY", _e, ae), ye([
                    "YYYYY",
                    "YYYYYY"
                ], De), ye("YYYY", function(e, t) {
                ...
                function Ge(e, t, a) {
                    var s, n, r = Ie(e.year(), t, a), i = Math.floor((e.dayOfYear() - r - 1) / 7) + 1;
                ...
                A("w", [
                    ...
                    "WW",
                    2
                ], "Wo", "isoWeek"), J("week", "w"), J("isoWeek", "W"), U("week", 5), U("isoWeek", 5), he("w", se), he("ww", se, X), he("W", se), he("WW", se, X), fe([
                    "w",
                    "ww",
                    "W",
                    "WW"
                ...
                var qe = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), Ke = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Ze = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), $e = ce, Qe = ce, Xe = ce;
                function et() {
                    function e(e, t) {
                        return t.length - e.length;
                    }
                    ...
                    for(t = 0; t < 7; t++)a = h([
                        2000,
                        1
                    ]).day(t), s = Le(this.weekdaysMin(a, "")), n = Le(this.weekdaysShort(a, "")), r = Le(this.weekdays(a, "")), i.push(s), d.push(n), _.push(r), o.push(s), o.push(n), o.push(r);
                ...
                }), at("a", !0), at("A", !1), J("hour", "h"), U("hour", 13), he("a", st), he("A", st), he("H", se), he("h", se), he("k", se), he("HH", se, X), he("hh", se, X), he("kk", se, X), he("hmm", ne), he("hmmss", re), he("Hmm", ne), he("Hmmss", re), ye([
                    "H",
                    "HH"
                ], we), ye([
                    "k",
                ...
                var Lt = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, Yt = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d|))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, yt = /Z|[+-]\d\d(?::?\d\d)?/, ft = [
                    [
                        "YYYYYY-MM-DD",
                        /[+-]\d{6}-\d\d-\d\d/
                    ],
                ...
                ], kt = /^\/?Date\((-?\d+)/i, Dt = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/, gt = {
                    UT: 0,
                    GMT: 0,
                    EDT: -240,
                    EST: -300,
                ...
                function Tt(e) {
                    var t, a, s, n, r, i, d = e._i, _ = Lt.exec(d) || Yt.exec(d);
                    if (_) {
                        for(M(e).iso = !0, t = 0, a = ft.length; t < a; t++)if (ft[t][1].exec(_[1])) {
                            n = ft[t][0], s = !1 !== ft[t][2];
                            break;
                        }
                        if (null == n) return void (e._isValid = !1);
                        if (_[3]) {
                            for(t = 0, a = pt.length; t < a; t++)if (pt[t][1].exec(_[3])) {
                                r = (_[2] || " ") + pt[t][0];
                                break;
                            }
                ...
                function Ht(e) {
                    if (e._f !== n.ISO_8601) {
                        if (e._f !== n.RFC_2822) {
                            e._a = [], M(e).empty = !0;
                            var t, a, s, r, i, d, _ = "" + e._i, o = _.length, u = 0;
                ...
                function jt(e) {
                    ...
                    return e._locale = e._locale || ht(e._l), null === t || void 0 === a && "" === t ? Y({
                        ...
                        for(n = 0; n < e._f.length; n++)r = 0, i = !1, t = p({
                        }, e), null != e._useUTC && (t._useUTC = e._useUTC), t._f = e._f[n], Ht(t), L(t) && (i = !0), r += M(t).charsLeftOver, r += 10 * M(t).unusedTokens.length, M(t).score = r, d ? r < s && (s = r, a = t) : (null == s || r < s || i) && (s = r, a = t, i && (d = !0));
                        c(e, a || t);
                    })(e) : a ? Ht(e) : (function(e) {
                        var t = e._i;
                        o(t) ? e._d = new Date(n.now()) : m(t) ? e._d = new Date(t.valueOf()) : "string" == typeof t ? (function(e) {
                            ...
                            if (!e._d) {
                                var t = C(e._i), a = void 0 === t.day ? t.date : t.day;
                                e._a = l([
                                    t.year,
                                    t.month,
                                    a,
                ...
                function Ft(e) {
                    var t = C(e), a = t.year || 0, s = t.quarter || 0, n = t.month || 0, r = t.week || t.isoWeek || 0, i = t.day || 0, _ = t.hour || 0, o = t.minute || 0, u = t.second || 0, m = t.millisecond || 0;
                    this._isValid = (function(e) {
                        var t, a, s = !1;
                        for(t in e)if (d(e, t) && (-1 === ke.call(At, t) || null != e[t] && isNaN(e[t]))) return !1;
                        for(a = 0; a < At.length; ++a)if (e[At[a]]) {
                            if (s) return !1;
                            parseFloat(e[At[a]]) !== B(e[At[a]]) && (s = !0);
                        }
                        return !0;
                    })(t), this._milliseconds = +m + 1000 * u + 60000 * o + 1000 * _ * 3600, this._days = +i + 7 * r, this._months = +n + 3 * s + 12 * a, this._data = {
                ...
                Jt("Z", ":"), Jt("ZZ", ""), he("Z", le), he("ZZ", le), ye([
                    "Z",
                    "ZZ"
                ], function(e, t, a) {
                ...
                function Ct(e, t) {
                    var a, s, n = (t || "").match(e);
                    return null === n ? null : 0 === (s = 60 * (a = ((n[n.length - 1] || []) + "").match(Rt) || [
                        "-",
                        0,
                        0
                    ])[1] + B(a[2])) ? 0 : "+" === a[0] ? s : -s;
                ...
                function qt(e, t) {
                    var a, s, n, r, i, _, o = e, m = null;
                    return zt(e) ? o = {
                        ms: e._milliseconds,
                        d: e._days,
                        M: e._months
                    } : u(e) || !isNaN(+e) ? (o = {
                    }, t ? o[t] = +e : o.milliseconds = +e) : (m = Vt.exec(e)) ? (a = "-" === m[1] ? -1 : 1, o = {
                        y: 0,
                        d: B(m[Te]) * a,
                        h: B(m[we]) * a,
                        m: B(m[ve]) * a,
                    ...
                    } : "object" == typeof o && ("from" in o || "to" in o) && (r = Ot(o.from), i = Ot(o.to), n = r.isValid() && i.isValid() ? (i = It(i, r), r.isBefore(i) ? _ = Zt(r, i) : ((_ = Zt(i, r)).milliseconds = -_.milliseconds, _.months = -_.months), _) : {
                        milliseconds: 0,
                        months: 0
                    }, (o = {
                    }).ms = n.milliseconds, o.M = n.months), s = new Ft(o), zt(e) && d(e, "_locale") && (s._locale = e._locale), zt(e) && d(e, "_isValid") && (s._isValid = e._isValid), s;
                }
                function Kt(e, t) {
                ...
                function Qt(e, t, a, s) {
                    var r = t._milliseconds, i = Nt(t._days), d = Nt(t._months);
                ...
                var Xt = $t(1, "add"), ea = $t(-1, "subtract");
                function ta(e) {
                    return "string" == typeof e || e instanceof String;
                }
                function aa(e, t) {
                    if (e.date() < t.date()) return -aa(t, e);
                    var a = 12 * (t.year() - e.year()) + (t.month() - e.month()), s = e.clone().add(a, "months");
                ...
                var ia = 1000, da = 60 * ia, _a = 60 * da, oa = 3506328 * _a;
                function ua(e, t) {
                    return (e % t + t) % t;
                }
                function ma(e, t, a) {
                ...
                function La(e, t, a, s, n) {
                    ...
                    return null == e ? Ge(this, s, n).year : (t > (r = Ve(e, s, n)) && (t = r), (function(e, t, a, s, n) {
                        var r = Ue(e, t, a, s, n), i = Ce(r.year, 0, r.dayOfYear);
                        return this.year(i.getUTCFullYear()), this.month(i.getUTCMonth()), this.date(i.getUTCDate()), this;
                    }).call(this, e, t, a, s, n));
                }
                A("N", 0, 0, "eraAbbr"), A("NN", 0, 0, "eraAbbr"), A("NNN", 0, 0, "eraAbbr"), A("NNNN", 0, 0, "eraName"), A("NNNNN", 0, 0, "eraNarrow"), A("y", [
                    "y",
                    1
                ], "yo", "eraYear"), A("y", [
                    "yy",
                    ...
                    "yyyy",
                    4
                ], 0, "eraYear"), he("N", ca), he("NN", ca), he("NNN", ca), he("NNNN", function(e, t) {
                ...
                }), Ma("gggg", "weekYear"), Ma("ggggg", "weekYear"), Ma("GGGG", "isoWeekYear"), Ma("GGGGG", "isoWeekYear"), J("weekYear", "gg"), J("isoWeekYear", "GG"), U("weekYear", 1), U("isoWeekYear", 1), he("G", ue), he("g", ue), he("GG", se, X), he("gg", se, X), he("GGGG", de, te), he("gggg", de, te), he("GGGGG", _e, ae), he("ggggg", _e, ae), fe([
                    "gggg",
                    "ggggg",
                    "GGGG",
                    "GGGGG"
                    ...
                    "DD",
                    2
                ], "Do", "date"), J("date", "D"), U("date", 9), he("D", se), he("DD", se, X), he("Do", function(e, t) {
                    return e ? t._dayOfMonthOrdinalParse || t._ordinalParse : t._dayOfMonthOrdinalParseLenient;
                }), ye([
                    "D",
                    "DD"
                ], Te), ye("Do", function(e, t) {
                    t[Te] = B(e.match(se)[0]);
                });
                var Ya = q("Date", !0);
                A("DDD", [
                    "DDDD",
                    3
                ], "DDDo", "dayOfYear"), J("dayOfYear", "DDD"), U("dayOfYear", 4), he("DDD", ie), he("DDDD", ee), ye([
                    "DDD",
                    "DDDD"
                ], function(e, t, a) {
                    a._dayOfYear = B(e);
                    ...
                    "mm",
                    2
                ], 0, "minute"), J("minute", "m"), U("minute", 14), he("m", se), he("mm", se, X), ye([
                    "m",
                    "mm"
                ], ve);
                var ya = q("Minutes", !1);
                A("s", [
                    "ss",
                    2
                ], 0, "second"), J("second", "s"), U("second", 15), he("s", se), he("ss", se, X), ye([
                    "s",
                    "ss"
                ], be);
                ...
                ga.add = Xt, ga.calendar = function(e, t) {
                    ...
                    var s = e || Ot(), o = It(s, this).startOf("day"), l = n.calendarFormat(this, o) || "sameElse", c = t && (S(t[l]) ? t[l].call(this, s) : t[l]);
                    ...
                    switch(n = 60000 * (s.utcOffset() - this.utcOffset()), t = R(t)){
                        case "year":
                            r = aa(this, s) / 12;
                            break;
                        case "month":
                    ...
                    return a.year() < 0 || a.year() > 9999 ? F(a, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : S(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1000).toISOString().replace("Z", F(a, "Z")) : F(a, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ");
                }, ga.inspect = function() {
                    if (!this.isValid()) return "moment.invalid(/* " + this._i + " */)";
                    var e, t, a, s = "moment", n = "";
                    ...
                    for(e = 0, t = r.length; e < t; ++e)if (a = r[e].since <= r[e].until ? 1 : -1, s = this.startOf("day").valueOf(), r[e].since <= s && s <= r[e].until || r[e].until <= s && s <= r[e].since) return (this.year() - n(r[e].since).year()) * a + r[e].offset;
                    return this.year();
                ...
                function Sa(e, t, a, s) {
                    ...
                    var n, r = ht(), i = e ? r._week.dow : 0, d = [];
                ...
                wa.calendar = function(e, t, a) {
                    ...
                    for(e = e.toUpperCase(), s = 0, n = _.length; s < n; ++s)if (r = _[s].name.toUpperCase(), i = _[s].abbr.toUpperCase(), d = _[s].narrow.toUpperCase(), a) switch(t){
                        case "N":
                        case "NN":
                        case "NNN":
                            if (i === e) return _[s];
                    ...
                    if (this._monthsParseExact) return (function(e, t, a) {
                        ...
                        if (!this._monthsParse) for(this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], s = 0; s < 12; ++s)r = h([
                            2000,
                            s
                    ...
                    for(this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), s = 0; s < 12; s++){
                        if (n = h([
                            2000,
                            s
                        ]), a && !this._longMonthsParse[s] && (this._longMonthsParse[s] = new RegExp("^" + this.months(n, "").replace(".", "") + "$", "i"), this._shortMonthsParse[s] = new RegExp("^" + this.monthsShort(n, "").replace(".", "") + "$", "i")), a || this._monthsParse[s] || (r = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""), this._monthsParse[s] = new RegExp(r.replace(".", ""), "i")), a && "MMMM" === t && this._longMonthsParse[s].test(e)) return s;
                    ...
                    if (this._weekdaysParseExact) return (function(e, t, a) {
                        var s, n, r, i = e.toLocaleLowerCase();
                        if (!this._weekdaysParse) for(this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], s = 0; s < 7; ++s)r = h([
                            2000,
                            1
                    ...
                    for(this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), s = 0; s < 7; s++){
                        if (n = h([
                            2000,
                            1
                        ]).day(s), a && !this._fullWeekdaysParse[s] && (this._fullWeekdaysParse[s] = new RegExp("^" + this.weekdays(n, "").replace(".", "\\.?") + "$", "i"), this._shortWeekdaysParse[s] = new RegExp("^" + this.weekdaysShort(n, "").replace(".", "\\.?") + "$", "i"), this._minWeekdaysParse[s] = new RegExp("^" + this.weekdaysMin(n, "").replace(".", "\\.?") + "$", "i")), this._weekdaysParse[s] || (r = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[s] = new RegExp(r.replace(".", ""), "i")), a && "dddd" === t && this._fullWeekdaysParse[s].test(e)) return s;
                ...
                var Ea = Wa("ms"), Aa = Wa("s"), Fa = Wa("m"), za = Wa("h"), Na = Wa("d"), Ja = Wa("w"), Ra = Wa("M"), Ca = Wa("Q"), Ia = Wa("y");
                function Ua(e) {
                    return function() {
                        return this.isValid() ? this._data[e] : NaN;
                    };
                }
                var Ga = Ua("milliseconds"), Va = Ua("seconds"), Ba = Ua("minutes"), qa = Ua("hours"), Ka = Ua("days"), Za = Ua("months"), $a = Ua("years"), Qa = Math.round, Xa = {
                    ss: 44,
                    s: 45,
                    m: 45,
                    h: 22,
                ...
                function as() {
                    ...
                    var e, t, a, s, n, r, i, d, _ = es(this._milliseconds) / 1000, o = es(this._days), u = es(this._months), m = this.asSeconds();
                ...
                return ss.isValid = function() {
                    ...
                    if ("month" === (e = R(e)) || "quarter" === e || "year" === e) switch(t = this._days + s / 86400000, a = this._months + Oa(t), e){
                        case "month":
                            return a;
                        case "quarter":
                            return a / 3;
                    ...
                    var e, t, a, s, n, r = this._milliseconds, i = this._days, d = this._months, _ = this._data;
                    return r >= 0 && i >= 0 && d >= 0 || r <= 0 && i <= 0 && d <= 0 || (r += 86400000 * xa(Pa(d) + i), i = 0, d = 0), _.milliseconds = r % 1000, e = V(r / 1000), _.seconds = e % 60, t = V(e / 60), _.minutes = t % 60, a = V(t / 60), _.hours = a % 24, i += V(a / 24), n = V(Oa(i)), d += n, i -= xa(Pa(n)), s = V(d / 12), d %= 12, _.days = i, _.months = d, _.years = s, this;
                }, ss.clone = function() {
                    return qt(this);
                }, ss.get = function(e) {
                    ...
                    if (!this.isValid()) return this.localeData().invalidDate();
                    var a, s, n = !1, r = Xa;
                    return "object" == typeof e && (t = e, e = !1), "boolean" == typeof e && (n = e), "object" == typeof t && (r = Object.assign({
                    }, Xa, t), null != t.s && null == t.ss && (r.ss = t.s - 1)), a = this.localeData(), s = (function(e, t, a, s) {
                        var n = qt(e).abs(), r = Qa(n.as("s")), i = Qa(n.as("m")), d = Qa(n.as("h")), _ = Qa(n.as("d")), o = Qa(n.as("M")), u = Qa(n.as("w")), m = Qa(n.as("y")), l = r <= a.ss && [
                            "s",
                            r
                        ] || r < a.s && [
                            "ss",
                        ...
                        return null != a.w && (l = l || u <= 1 && [
                            ...
                            "yy",
                            m
                        ])[2] = t, l[3] = +e > 0, l[4] = s, (function(e, t, a, s, n) {
                    ...
                    a._d = new Date(1000 * parseFloat(e));
                }), ye("x", function(e, t, a) {
                    a._d = new Date(B(e));
                }), //! moment.js
    ...
    function(e, t, a) {
        !function(e) {
            ...
            var a = [
                ...
                /^du/i,
                /^ker/i
            ], s = /^(genver|c[ʼ\']hwevrer|meurzh|ebrel|mae|mezheven|gouere|eost|gwengolo|here|du|kerzu|gen|c[ʼ\']hwe|meu|ebr|mae|eve|gou|eos|gwe|her|du|ker)/i, n = [
                /^Su/i,
                /^Lu/i,
                /^Me([^r]|$)/i,
                /^Mer/i,
    ...
    function(e, t, a) {
        !function(e) {
            //! moment.js locale configuration
            var t = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_"), a = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"), s = [
                /^led/i,
                /^úno/i,
                /^bře/i,
                /^dub/i,
        ...
        !function(e) {
            ...
            e.defineLocale("el", {
                ...
                calendar: function(e, t) {
                    var a, s = this._calendarEl[e], n = t && t.hours();
    ...
    function(e, t, a) {
        !function(e) {
            //! moment.js locale configuration
            var t = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"), a = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"), s = [
                /^ene/i,
                /^feb/i,
                /^mar/i,
                /^abr/i,
    ...
    function(e, t, a) {
        !function(e) {
            //! moment.js locale configuration
            var t = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "), a = [
                "nolla",
                "yhden",
                "kahden",
                "kolmen",
    ...
    function(e, t, a) {
        !function(e) {
            //! moment.js locale configuration
            var t = /(janv\.?|févr\.?|mars|avr\.?|mai|juin|juil\.?|août|sept\.?|oct\.?|nov\.?|déc\.?|janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre)/i, a = [
                /^janv/i,
                /^févr/i,
                /^mars/i,
                /^avr/i,
    ...
    function(e, t, a) {
        !function(e) {
            //! moment.js locale configuration
            var t = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"), a = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), s = [
                /^jan/i,
                /^feb/i,
                /^maart|mrt.?$/i,
                /^apr/i,
    ...
    function(e, t, a) {
        !function(e) {
            ...
            function a(e, a, s, n) {
                var r = function(e) {
                    var a = Math.floor(e % 1000 / 100), s = Math.floor(e % 100 / 10), n = e % 10, r = "";
    ...
    function(e2, t, a) {
        ...
        function d(e, t) {
            for(var a = [], s = {
                ...
                var r = e[n], i = t.base ? r[0] + t.base : r[0], d = {
                    css: r[1],
                    media: r[2],
                    sourceMap: r[3]
                };
        ...
        function l(e, t, a, s) {
            ...
            if (e.styleSheet) e.styleSheet.cssText = m(t, n);
                ...
                var r = document.createTextNode(n), i = e.childNodes;
        ...
        function M(e, t) {
            ...
            if (t.singleton) {
                ...
                var s = a.css, n = a.media, r = a.sourceMap;
        ...
        e2.exports = function(e, t) {
            (t = t || {
            }).attributes = "object" == typeof t.attributes ? t.attributes : {
    ...
    function(e, t, a) {
        (function() {
            ...
            e = null != (s = a(140)) ? s : this.countdown, (t = null != (n = a(0)) ? n : this.moment).fn.countdown = function() {
                var a, s;
                return s = arguments[0], a = 2 <= arguments.length ? r.call(arguments, 1) : [], e.apply(null, [
                    this.toDate(),
                    t(s).toDate()
                ].concat(r.call(a)));
            };
     ...
     */ !function(e) {
            var t = 1, a = 2, s = 4, n = 8, r = 16, i = 32, d = 64, _ = 128, o = 256, u = 512, m = 1024, l = _ | d | r | n | s | a, c = 1000, h = 60, M = 60, L = 24, Y = L * M * h * c, y = 7, f = 12, p = 10, k = 10, D = 10, g = Math.ceil, T = Math.floor;
            function w(e, t) {
                var a = e.getTime();
                return e.setMonth(e.getMonth() + t), Math.round((e.getTime() - a) / Y);
            }
            function v(e) {
                var t = e.getTime(), a = new Date(t);
            ...
            function J(e, l, Y, v, b, S) {
                ...
                try {
                    e.millennia = 0, e.centuries = 0, e.decades = 0, e.years = Y.getFullYear() - l.getFullYear(), e.months = Y.getMonth() - l.getMonth(), e.weeks = 0, e.days = Y.getDate() - l.getDate(), e.hours = Y.getHours() - l.getHours(), e.minutes = Y.getMinutes() - l.getMinutes(), e.seconds = Y.getSeconds() - l.getSeconds(), e.milliseconds = Y.getMilliseconds() - l.getMilliseconds(), (function(e) {
                        var t;
    ...
    function(e, t, a) {
        ...
        !function(e) {
            var t = a(0);
            a(139), t().format();
            var s = document.querySelector(".days"), n = document.querySelector(".hours"), r = document.querySelector(".minutes"), i = document.querySelector(".seconds");
            setInterval(function() {
                var a = t().countdown(e, t().countdown.MONTHS | t().countdown.DAYS | t().countdown.HOURS | t().countdown.MINUTES | t().countdown.SECONDS), d = t().countdown(e);
...
//# sourceMappingURL=index.9a2dc729.js.map
